        ...
        <section>
          <div className="pb-24 pt-12 md:pb-32 lg:pb-56 lg:pt-44">
            <div className="relative mx-auto flex max-w-6xl flex-col px-6 lg:block">
              ...
              <Image
                className="-z-10 order-first ml-auto h-56 w-full object-cover invert sm:h-96 lg:absolute lg:inset-0 lg:-right-0 lg:-top-40 lg:order-last lg:h-max lg:w-3/5 lg:object-contain dark:mix-blend-lighten dark:invert-0"
                src="https://static.wikia.nocookie.net/valorant-lore/images/d/dc/Omen_-_Full_body.png"
                alt="Abstract Object"
                height="4000"
                width="3000"
              />
